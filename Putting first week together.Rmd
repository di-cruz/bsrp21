---
title: "Project RAD's first week"
...
prism3a = prism2a*prism_overlap
prism4a = na_if(prism3a, 0) #making prism data that is positive, NA
crispr_overlap <- crispr[cell_lines, ]

correlationsa <- cor(prism4a, crispr_overlap, use = "pairwise.complete.obs") #pairwsie mean ignore missing values if missing in one or the other
```